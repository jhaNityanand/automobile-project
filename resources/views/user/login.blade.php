...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{ url('saveUserLogin') }}" method="POST" autocomplete="off">
        @csrf
      ...
      <p align="center" class="mb-1">
        <a href="{{ url('userRegister') }}">Register a New Membership</a>
      </p>

      <p align="center" class="mb-1">
        <a href="{{ url('userForgotPassword') }}">I Forgot my Password</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
