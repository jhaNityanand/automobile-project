...
<head>
  ...
  <title>Automobile-Parts Project</title>
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="{{url('public/images/logo.jpg')}}">
...
<div class="wrapper">
  ...
  <!-- Navbar -->
  @include('layout-1.header')
  <!-- /.navbar -->

  <!-- Main Sidebar Container -->
  @include('layout-1.sidebar')
