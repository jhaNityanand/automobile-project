...
<head>
  ...
  <title>Show All City Records</title>
          ...
          <form id="myform" name="myform" autocomplete="off">
            ...
            <div class="card card-info">
              <div class="card-header">
                <label style="color: white;" class="card-title">Add New City</label>
              </div>
              <div class="card-body">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group text-center">
                    <button type="button" id="tbl_btn" class="btn btn-danger">Cancle</button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      @csrf
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><b>Update City</b></h5>
          ...
          <div class="modal-body">
              <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="cat_update" class="form-control" id="cat_update" placeholder="City Name">
          ...
          <div class="modal-footer">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button type="submit" id="submit" class="btn btn-success">Update City</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </div>
        </div>
      </form>
...
<script>
    $("#myform").submit(function(e){
          ...
          if(name == ""){
              $('#cat_error').fadeIn();
              $("#cat_error").html("City Name is Required...");
              setTimeout(function(){
...
<script>
    function send_del(delid){
      var delete_id = delid;
      if(confirm("Are you sure delete selected City???"))
      {
            $.ajaxSetup({
                headers: {
...
<script>
    $("#myform_update").submit(function(e){
          ...
          if(name_update == ""){
              $(".update").html("City Name is Required...");
          }
