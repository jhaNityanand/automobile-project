...
<head>
  ...
  <title>Show All Category Records</title>
    ...
    <section id="" class="content">
        {{-- <div class="card ">
            <div class="card-header text-center">
                <button type="button" id="modal_btn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add New Category</button>
            </div>
        </div> --}}<br>
            ...
            <div class="col-20">
              <div class="card">
                {{-- <div class="card-header">
                  <h1 id="center" class=""> All Category Records </h1>
                </div> --}}

                <!-- /.card-header -->
                <div class="card-body">
                <button type="button" id="modal_btn" class="float-right btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add New Category</button>
                <br><br>
        ...
        <div class="modal-body">
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="cat" class="form-control" id="cat" placeholder="Category Name">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Category Name : </label>
                    <input type="text" name="cat_update" class="form-control" id="cat_update" placeholder="Category Name">
          ...
          <div class="modal-footer">
            <button type="button" id="btn_can" class="btn btn-danger" data-bs-dismiss="modal">Cancle</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button type="submit" id="submit" class="btn btn-success">Update Category</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </div>
        </div>
      </form>
...
<script>
    $("#myform_update").submit(function(e){
          ...
          if(name_update == ""){
              $(".update").html("Category Name is Required...");
          }
...
<script>
    function send_del(delid){
      var delete_id = delid;
      if(confirm("Are you sure delete selected Category???"))
      {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
