                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="sticker-area-2">
                                                        <span style="background-color: greenyellow; color:indigo;" class="sticker-2"># {{ $serial++ }}</span>
                                                    </div>
                                                            ...
                                                            <li>
                                                                @php
                                                                    if($pro->status == "In Stock"){
                                                                        print('<button class="btn btn-outline-success btn-ft" type="button" name="btnlogin"><b>'.$pro->status.'</b></button>');
                                                                    }else{
                                                                        print('<button class="btn btn-outline-danger btn-ft" type="button" name="btnlogin"><b>'.$pro->status.'</b></button>');
                                                                    }
                                                                @endphp
                                                            </li>
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-content">
                                                <div class="product-desc_info">
                                                    ...
                                                    <div><a class="product-name" href="#"><h3>{{ $pro->name }}</h3></a></div>
                                                    <div class="price-box">
                                                        <span class="new-price"><b>Price :</b> ₹ {{ $pro->price }}.00</span>
                                                    </div>
                                                    <div><a class="product-name" href="#"><b>Brand : </b>{{ $pro->brand }}</a></div>
